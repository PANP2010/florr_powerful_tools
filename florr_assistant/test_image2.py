...
def main():
    ...
    image_path = Path("/Users/panjiyang/Documents/trae_projects/florr_powerful_tools/florr-auto-framework-pytorch/测试图2.png")
    print(f"\n测试图片: {image_path}")
    ...
    output_path = Path("/Users/panjiyang/Documents/trae_projects/florr_powerful_tools/florr-auto-framework-pytorch/测试图2_结果.png")
