...
def one_hot_encode_mob(mob_name: str):
    ...
    "bubble", "bumble_bee", "bush",
    "cactus", "centipede", "centipede_body", "centipede_desert", "centipede_desert_body", "centipede_evil", "centipede_evil_body", "centipede_hel", "centipede_hel_body", "crab", "crab_mecha",
    "dandelion", "digger", "dummy",
    "fire_ant_baby", "fire_ant_burrow", "fire_ant_egg", "fire_ant_queen", "fire_ant_soldier", "fire_ant_worker", "firefly", "firefly_magic", "fly",
    "gambler", "gambler_old",
    "hornet",
    "jellyfish",
    "ladybug", "ladybug_dark", "ladybug_shiny", "leafbug", "leafbug_shiny", "leech", "leech_body",
    "mantis", "mecha_flower", "mecha_flower_old", "moth",
    "oracle",
    "roach", "rock",
    "sandstorm", "scorpion", "shell", "spider", "spider_hel", "spider_mecha", "sponge", "square", "starfish",
    "termite_baby", "termite_egg", "termite_mound", "termite_overmind", "termite_soldier", "termite_worker", "titan", "tomb", "trader",
...
def get_if_equip(image, templates, threshold=0.8):
